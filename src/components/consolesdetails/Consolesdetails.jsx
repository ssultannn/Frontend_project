...
function Consolesdetails(props) {
  ...
  const consolesIndex = parseInt(index);

  const selectedProduct = consoles[consolesIndex]; // Исправлено имя переменной
...
export default connect(mapStateToProps)(Consolesdetails);
