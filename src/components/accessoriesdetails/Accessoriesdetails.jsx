...
function Accessoriesdetails(props) {
  ...
  const accessoriesIndex = parseInt(index);

  const selectedProduct = accessories[accessoriesIndex]; // Исправлено имя переменной
...
export default connect(mapStateToProps)(Accessoriesdetails);
